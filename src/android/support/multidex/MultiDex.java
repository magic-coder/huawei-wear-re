...
public final class MultiDex {
    ...
    L_0x00f7:
        ...
        r4 = 0;
        r4 = android.support.multidex.C0019d.m74a(r6, r0, r3, r4);	 Catch:{ all -> 0x005a }
    ...
    L_0x0121:
        ...
        r4 = 1;
        r0 = android.support.multidex.C0019d.m74a(r6, r0, r3, r4);	 Catch:{ all -> 0x005a }
    ...
    private static void installSecondaryDexes(ClassLoader classLoader, File file, List<File> list) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException, IOException {
        if (!list.isEmpty()) {
            if (VERSION.SDK_INT >= 19) {
                C0017b.m70b(classLoader, list, file);
            } else if (VERSION.SDK_INT >= 14) {
                C0016a.m67b(classLoader, list, file);
            } else {
                C0018c.m72b(classLoader, list);
            }
        }
    }
