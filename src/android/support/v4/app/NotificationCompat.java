...
public class NotificationCompat {
    ...
    public class Action extends android.support.v4.app.NotificationCompatBase.Action {
        public static final Factory FACTORY = new C00521();
        ...
        final class C00521 implements Factory {
            C00521() {
            }
        ...
        public final class Builder {
            ...
            public Action build() {
                ...
                return new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, remoteInputArr, this.mAllowGeneratedReplies);
            }
        }
    ...
    public final class CarExtender implements Extender {
        ...
        public class UnreadConversation extends android.support.v4.app.NotificationCompatBase.UnreadConversation {
            static final android.support.v4.app.NotificationCompatBase.UnreadConversation.Factory FACTORY = new C00531();
            ...
            final class C00531 implements android.support.v4.app.NotificationCompatBase.UnreadConversation.Factory {
                C00531() {
                }
    ...
    public final class WearableExtender implements Extender {
        ...
        public WearableExtender(Notification notification) {
            ...
            if (bundle != null) {
                ...
                Notification[] access$600 = NotificationCompat.getNotificationArrayFromBundle(bundle, KEY_PAGES);
                if (access$600 != null) {
                    Collections.addAll(this.mPages, access$600);
                }
    ...
    private static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor, Style style) {
        if (style == null) {
            return;
        }
