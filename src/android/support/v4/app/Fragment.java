...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00321 extends FragmentContainer {
        C00321() {
        }
    ...
    public class SavedState implements Parcelable {
        ...
        final class C00331 implements Creator<SavedState> {
            C00331() {
            }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C00321(), this);
    }
