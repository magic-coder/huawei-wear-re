...
class NotificationCompatKitKat {
    ...
    public class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        private android.app.Notification.Builder f110b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f110b, action));
        }
        ...
        public Notification build() {
            ...
            this.f110b.setExtras(this.mExtras);
            Notification build = this.f110b.build();
