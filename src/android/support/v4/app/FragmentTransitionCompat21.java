...
class FragmentTransitionCompat21 {
    ...
    final class C00451 extends EpicenterCallback {
    ...
    final class C00462 implements OnPreDrawListener {
        ...
        C00462(View view, Transition transition, View view2, ViewRetriever viewRetriever, Map map, Map map2, ArrayList arrayList, Transition transition2) {
    ...
    final class C00473 extends EpicenterCallback {
        private Rect mEpicenter;
        final /* synthetic */ EpicenterView val$epicenterView;

        C00473(EpicenterView epicenterView) {
    ...
    final class C00484 implements OnPreDrawListener {
        final /* synthetic */ Transition val$enterTransition;
        final /* synthetic */ ArrayList val$enteringViews;
        final /* synthetic */ Transition val$exitTransition;
        ...
        C00484(View view, Transition transition, ArrayList arrayList, Transition transition2, ArrayList arrayList2, Transition transition3, ArrayList arrayList3, Map map, ArrayList arrayList4, Transition transition4, View view2) {
    ...
    public static void setEpicenter(Object obj, View view) {
        ((Transition) obj).setEpicenterCallback(new C00451(getBoundsOnScreen(view)));
    }
    ...
    private static void excludeViews(Transition transition, Transition transition2, ArrayList<View> arrayList, boolean z) {
        if (transition != null) {
    ...
    public static void excludeSharedElementViews(Object obj, Object obj2, Object obj3, ArrayList<View> arrayList, boolean z) {
        ...
        excludeViews((Transition) obj, transition2, arrayList, z);
        excludeViews(transition, transition2, arrayList, z);
    }
    ...
    public static void addTransitionTargets(Object obj, Object obj2, Object obj3, View view, ViewRetriever viewRetriever, View view2, EpicenterView epicenterView, Map<String, String> map, ArrayList<View> arrayList, ArrayList<View> arrayList2, Map<String, View> map2, Map<String, View> map3, ArrayList<View> arrayList3) {
        ...
        if (obj != null || obj2 != null) {
            ...
            view.getViewTreeObserver().addOnPreDrawListener(new C00462(view, transition, view2, viewRetriever, map, map3, arrayList, transition2));
    ...
    private static void setSharedElementEpicenter(Transition transition, EpicenterView epicenterView) {
        if (transition != null) {
            transition.setEpicenterCallback(new C00473(epicenterView));
        }
    }
    ...
    public static void cleanupTransitions(View view, View view2, Object obj, ArrayList<View> arrayList, Object obj2, ArrayList<View> arrayList2, Object obj3, ArrayList<View> arrayList3, Object obj4, ArrayList<View> arrayList4, Map<String, View> map) {
        ...
        if (transition4 != null) {
            view.getViewTreeObserver().addOnPreDrawListener(new C00484(view, transition, arrayList, transition2, arrayList2, transition3, arrayList3, map, arrayList4, transition4, view2));
        }
    }
