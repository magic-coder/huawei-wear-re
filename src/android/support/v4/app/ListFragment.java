...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00502();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00491();
    ...
    class C00502 implements OnItemClickListener {
        C00502() {
        }
