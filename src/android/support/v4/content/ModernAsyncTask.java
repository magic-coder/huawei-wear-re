...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00582();

    final class C00571 implements ThreadFactory {
    ...
    class C00582 extends WorkerRunnable<Params, Result> {
        C00582() {
            super();
        }
