...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01861();
    ...
    private final Runnable mSetIdleRunnable = new C01872();
    ...
    final class C01861 implements Interpolator {
        C01861() {
        }
    ...
    public static ViewDragHelper create(ViewGroup viewGroup, float f, Callback callback) {
        ...
        create.mTouchSlop = (int) (((float) create.mTouchSlop) * (DefaultRetryPolicy.DEFAULT_BACKOFF_MULT / f));
        return create;
    }
    ...
    private int computeAxisDuration(int i, int i2, int i3) {
        ...
        int i4 = width / 2;
        float distanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, ((float) Math.abs(i)) / ((float) width))) * ((float) i4)) + ((float) i4);
        i4 = Math.abs(i2);
        if (i4 > 0) {
