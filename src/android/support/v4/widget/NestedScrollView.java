...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild, NestedScrollingParent, ScrollingView {
    ...
    class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C01711();
        public int scrollPosition;

        final class C01711 implements Creator<SavedState> {
            C01711() {
            }
                        ...
                        if (!dispatchNestedScroll(0, scrollY2, 0, i - scrollY2, this.mScrollOffset)) {
                            if (obj != null) {
                                ...
                                if (actionMasked < 0) {
                                    ...
                                    this.mEdgeGlowBottom.onPull(((float) i) / ((float) getHeight()), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - (MotionEventCompat.getX(motionEvent, findPointerIndex) / ((float) getWidth())));
