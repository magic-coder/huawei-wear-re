...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    class C01781 implements AnimationListener {
        C01781() {
        }
    ...
    class C01792 extends Animation {
        C01792() {
        }
    ...
    class C01803 extends Animation {
        C01803() {
        }
    ...
    class C01825 implements AnimationListener {
        C01825() {
        }
    ...
    class C01836 extends Animation {
        C01836() {
        }
    ...
    class C01847 extends Animation {
        C01847() {
        }
    ...
    class C01858 extends Animation {
        C01858() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new C01781();
        this.mAnimateToCorrectPosition = new C01836();
        this.mAnimateToStartPosition = new C01847();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new C01792();
    ...
    private void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new C01803();
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        ...
        Animation c01814 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        c01814.setDuration(300);
        this.mCircleView.setAnimationListener(null);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(c01814);
        return c01814;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            case 0:
                ...
                if (motionEventY != GroundOverlayOptions.NO_DIMENSION) {
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new C01858();
