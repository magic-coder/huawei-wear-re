...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C01703();
    boolean mFinishing;
    ...
    class C01703 implements Callback {
        C01703() {
        }
    ...
    private void setupAnimators() {
        ...
        Animation c01681 = new Animation() {
        ...
        c01681.setRepeatCount(-1);
        c01681.setRepeatMode(1);
        c01681.setInterpolator(LINEAR_INTERPOLATOR);
        c01681.setAnimationListener(new AnimationListener() {
