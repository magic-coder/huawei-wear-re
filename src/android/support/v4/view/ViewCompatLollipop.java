...
class ViewCompatLollipop {
    ...
    final class C01421 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListener val$listener;

        C01421(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        if (onApplyWindowInsetsListener == null) {
            ...
            view.setOnApplyWindowInsetsListener(new C01421(onApplyWindowInsetsListener));
        }
    }
