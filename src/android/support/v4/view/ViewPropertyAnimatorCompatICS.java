...
class ViewPropertyAnimatorCompatICS {
    ...
    final class C01491 extends AnimatorListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorListener val$listener;
        final /* synthetic */ View val$view;

        C01491(ViewPropertyAnimatorListener viewPropertyAnimatorListener, View view) {
    ...
    public static void m102x(View view, float f) {
        view.animate().x(f);
    }
    ...
    public static void m103y(View view, float f) {
        view.animate().y(f);
    }
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new C01491(viewPropertyAnimatorListener, view));
        } else {
