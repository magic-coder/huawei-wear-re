...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01431();
    ...
    private static final Interpolator sInterpolator = new C01442();
    ...
    private final Runnable mEndScrollRunnable = new C01453();
    ...
    final class C01431 implements Comparator<ItemInfo> {
        C01431() {
        }
    ...
    final class C01442 implements Interpolator {
        C01442() {
        }
    ...
    class C01464 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C01471());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        final class C01471 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01471() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01464());
    }
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        if (abs > 0) {
            ...
            currX = (int) (((((float) Math.abs(i5)) / ((((float) currX) * this.mAdapter.getPageWidth(this.mCurItem)) + ((float) this.mPageMargin))) + DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) * 100.0f);
        }
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        this.mLastOffset = itemInfo.position == count + -1 ? (itemInfo.offset + itemInfo.widthFactor) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : AutoScrollHelper.NO_MAX;
        for (i3 = i - 1; i3 >= 0; i3--) {
        ...
        for (i3 = i + 1; i3 < size; i3++) {
            ...
            if (itemInfo3.position == count - 1) {
                this.mLastOffset = (itemInfo3.widthFactor + f2) - DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
            }
            itemInfo3.offset = f2;
            f3 = f2 + (itemInfo3.widthFactor + f);
            i2++;
