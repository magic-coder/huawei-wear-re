...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mFullUnderlineHeight = (int) ((DefaultRetryPolicy.DEFAULT_BACKOFF_MULT * f) + 0.5f);
        ...
        this.mPrevText.setOnClickListener(new C01381());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C01392());
