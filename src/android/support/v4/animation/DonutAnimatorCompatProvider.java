...
class DonutAnimatorCompatProvider implements AnimatorProvider {
    ...
    class DonutFloatValueAnimator implements ValueAnimatorCompat {
        ...
        private Runnable mLoopRunnable = new C00231();
        ...
        class C00231 implements Runnable {
            ...
            public void run() {
                float access$000 = (((float) (DonutFloatValueAnimator.this.getTime() - DonutFloatValueAnimator.this.mStartTime)) * DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) / ((float) DonutFloatValueAnimator.this.mDuration);
                if (access$000 > DefaultRetryPolicy.DEFAULT_BACKOFF_MULT || DonutFloatValueAnimator.this.mTarget.getParent() == null) {
