...
public final class RatingCompat implements Parcelable {
    public static final Creator<RatingCompat> CREATOR = new C00921();
    ...
    final class C00921 implements Creator<RatingCompat> {
        C00921() {
        }
    ...
    public static RatingCompat newHeartRating(boolean z) {
        return new RatingCompat(1, z ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean z) {
        return new RatingCompat(2, z ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == 2 && this.mRatingValue == DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) {
            return true;
        }
        return false;
    }
