...
public class TransportMediator extends TransportController {
    ...
    class C00931 implements TransportMediatorCallback {
        C00931() {
        }
    ...
    class C00942 implements Callback {
        C00942() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C00931();
        this.mKeyEventCallback = new C00942();
