...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle) {
        ...
        final String str2 = str;
        final Bundle bundle2 = bundle;
        Result c00751 = new Result<List<MediaItem>>(str) {
            void onResultSent(List<MediaItem> list, int i) {
        ...
        if (bundle == null) {
            onLoadChildren(str, c00751);
        } else {
            onLoadChildren(str, c00751, bundle);
        }
    ...
    private void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c00762 = new Result<MediaItem>(str) {
            void onResultSent(MediaItem mediaItem, int i) {
