...
public final class MediaBrowserCompat {
    ...
    public class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C00741();
        public static final int FLAG_BROWSABLE = 1;
        public static final int FLAG_PLAYABLE = 2;
        private final MediaDescriptionCompat mDescription;
        private final int mFlags;

        final class C00741 implements Creator<MediaItem> {
            C00741() {
            }
    ...
    public abstract class SubscriptionCallback {
        ...
        class StubApi24 extends StubApi21 implements SubscriptionCallback {
            private StubApi24() {
                super();
            }
