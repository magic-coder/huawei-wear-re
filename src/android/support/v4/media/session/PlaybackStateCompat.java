...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01111();
    ...
    final class C01111 implements Creator<PlaybackStateCompat> {
        C01111() {
        }
    ...
    public final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01121();
        ...
        final class C01121 implements Creator<CustomAction> {
            C01121() {
            }
