...
public class MediaSessionCompat {
    ...
    class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C01051();
        private VolumeProviderCompat mVolumeProvider;
        private int mVolumeType;

        class C01051 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C01051() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            Object c01062 = new C01062();
            if (VERSION.SDK_INT >= 18) {
                MediaSessionCompatApi18.setOnPlaybackPositionUpdateListener(this.mRccObj, MediaSessionCompatApi18.createPlaybackPositionUpdateListener(c01062));
            }
            if (VERSION.SDK_INT >= 19) {
                MediaSessionCompatApi19.setOnMetadataUpdateListener(this.mRccObj, MediaSessionCompatApi19.createMetadataUpdateListener(c01062));
            }
        }
    ...
    public final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01071();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        final class C01071 implements Creator<QueueItem> {
            C01071() {
            }
    ...
    final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01081();
        private ResultReceiver mResultReceiver;

        final class C01081 implements Creator<ResultReceiverWrapper> {
            C01081() {
            }
    ...
    public final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01091();
        private final Object mInner;

        final class C01091 implements Creator<Token> {
            C01091() {
            }
