...
class PathParser {
    ...
    public class PathDataNode {
        ...
        private PathDataNode(PathDataNode pathDataNode) {
            ...
            this.params = PathParser.m16b(pathDataNode.params, 0, pathDataNode.params.length);
        }
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            double d10 = (WeightedLatLng.DEFAULT_INTENSITY / d9) - 0.25d;
            if (d10 < 0.0d) {
        ...
        private static void arcToBezier(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            ...
            while (i < ceil) {
                ...
                d10 = ((Math.sqrt((d10 * (3.0d * d10)) + 4.0d) - WeightedLatLng.DEFAULT_INTENSITY) * Math.sin(d12 - d8)) / 3.0d;
                Path path2 = path;
    ...
    private static float[] m16b(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    public static PathDataNode[] m13a(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                m11a(arrayList, trim.charAt(0), m15b(trim));
            }
            i = a + 1;
            i2 = a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m11a(arrayList, str.charAt(i2), new float[0]);
        }
        return (PathDataNode[]) arrayList.toArray(new PathDataNode[arrayList.size()]);
    }

    public static PathDataNode[] m14a(PathDataNode[] pathDataNodeArr) {
    ...
    private static int m9a(String str, int i) {
        while (i < str.length()) {
    ...
    private static void m11a(ArrayList<PathDataNode> arrayList, char c, float[] fArr) {
        arrayList.add(new PathDataNode(c, fArr));
    }

    private static float[] m15b(String str) {
    ...
    private static void m10a(java.lang.String r7, int r8, android.support.graphics.drawable.C0006f r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.f42b = r1;
    ...
    L_0x0033:
        ...
        goto L_0x0008;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.graphics.drawable.PathParser.a(java.lang.String, int, android.support.graphics.drawable.f):void");
    }
}
