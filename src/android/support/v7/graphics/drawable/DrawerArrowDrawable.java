...
public class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate((float) bounds.centerX(), (float) (((double) ((float) ((((int) ((((float) bounds.height()) - (3.0f * f)) - (this.mBarGap * 2.0f))) / 4) * 2))) + ((((double) f) * 1.5d) + ((double) this.mBarGap))));
        if (this.mSpin) {
            canvas.rotate(((float) ((i ^ this.mVerticalMirror) != 0 ? -1 : 1)) * f2);
        } else if (i != 0) {
