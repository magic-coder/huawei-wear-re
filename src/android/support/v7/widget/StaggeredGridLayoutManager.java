...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private final Runnable mCheckForGapsRunnable = new C02791();
    ...
    class LazySpanLookup {
        ...
        class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C02811();
            int mGapDir;
            int[] mGapPerSpan;
            boolean mHasUnwantedGapAfter;
            int mPosition;

            final class C02811 implements Creator<FullSpanItem> {
                C02811() {
                }
    ...
    public class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C02821();
        ...
        final class C02821 implements Creator<SavedState> {
            C02821() {
            }
            ...
            while (i < childCount) {
                ...
                if (decoratedMeasurement < f) {
                    ...
                    if (((LayoutParams) childAt.getLayoutParams()).isFullSpan()) {
                        f2 = (DefaultRetryPolicy.DEFAULT_BACKOFF_MULT * decoratedMeasurement) / ((float) this.mSpanCount);
                    } else {
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int i) {
        SmoothScroller c02802 = new LinearSmoothScroller(recyclerView.getContext()) {
        ...
        c02802.setTargetPosition(i);
        startSmoothScroll(c02802);
    }
