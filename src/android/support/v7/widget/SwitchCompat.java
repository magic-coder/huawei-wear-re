...
public class SwitchCompat extends CompoundButton {
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        return new StaticLayout(transformation, this.mTextPaint, transformation != null ? (int) Math.ceil((double) Layout.getDesiredWidth(transformation, this.mTextPaint)) : 0, Alignment.ALIGN_NORMAL, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.0f, true);
    }
                ...
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        if (thumbScrollRange != 0) {
                            x = f / ((float) thumbScrollRange);
                        } else {
                            x = f > 0.0f ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : GroundOverlayOptions.NO_DIMENSION;
                        }
                        if (ViewUtils.isLayoutRtl(this)) {
                            x = -x;
                        }
                        x = constrain(x + this.mThumbPosition, 0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    private void animateThumbToCheckedState(final boolean z) {
        ...
        this.mPositionAnimator = new ThumbAnimation(this.mThumbPosition, z ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
        ...
        this.mPositionAnimator.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (SwitchCompat.this.mPositionAnimator == animation) {
                    SwitchCompat.this.setThumbPosition(z ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    ...
    private int getThumbOffset() {
        float f;
        if (ViewUtils.isLayoutRtl(this)) {
            f = DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - this.mThumbPosition;
        } else {
