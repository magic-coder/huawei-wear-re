...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    private static final Interpolator sQuinticInterpolator = new C02613();
    ...
    final class C02613 implements Interpolator {
        C02613() {
        }
    ...
    class C02624 implements ProcessCallback {
        C02624() {
        }
    ...
    class C02635 implements Callback {
        C02635() {
        }
    ...
    class C02646 implements Callback {
        C02646() {
        }
    ...
    public final class Recycler {
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                boolean z2 = RecyclerView.this.mAdapter != null && access$4900 && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder);
    ...
    public class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C02651();
        Parcelable mLayoutState;

        final class C02651 implements Creator<SavedState> {
            C02651() {
            }
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            if (sqrt > 0) {
                ...
                round = (int) (((((float) round) / ((float) width)) + DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) * BitmapDescriptorFactory.HUE_MAGENTA);
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C02591();
        ...
        this.mItemAnimatorRunner = new C02602();
        this.mViewInfoProcessCallback = new C02624();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C02635());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C02646());
    }
