...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02331 extends DataSetObserver {
        C02331() {
        }
    ...
    class C02342 implements OnGlobalLayoutListener {
        C02342() {
        }
    ...
    class C02364 extends DataSetObserver {
        C02364() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetOberver = new C02331();
        this.mOnGlobalLayoutListener = new C02342();
        ...
        this.mAdapter.registerDataSetObserver(new C02364());
