...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    public void animateToVisibility(int i) {
        ...
        if (i == 0) {
            ...
            ViewPropertyAnimatorCompat alpha = ViewCompat.animate(this).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    public void addTab(Tab tab, boolean z) {
        ...
        this.mTabLayout.addView(createTabView, new LinearLayoutCompat.LayoutParams(0, -1, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        if (this.mTabSpinner != null) {
    ...
    public void addTab(Tab tab, int i, boolean z) {
        View createTabView = createTabView(tab, false);
        this.mTabLayout.addView(createTabView, i, new LinearLayoutCompat.LayoutParams(0, -1, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        if (this.mTabSpinner != null) {
            ((TabAdapter) this.mTabSpinner.getAdapter()).notifyDataSetChanged();
        }
        if (z) {
