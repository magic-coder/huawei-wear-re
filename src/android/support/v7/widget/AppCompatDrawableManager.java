...
public final class AppCompatDrawableManager {
    ...
    private ColorStateList createSwitchTrackColorStateList(Context context) {
        ...
        iArr[1] = ThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated, NFCBaseActivity.PERCENT_MARGIN_30);
        r0[2] = ThemeUtils.EMPTY_STATE_SET;
        iArr[2] = ThemeUtils.getThemeAttrColor(context, 16842800, NFCBaseActivity.PERCENT_MARGIN_30);
        return new ColorStateList(r0, iArr);
    }
