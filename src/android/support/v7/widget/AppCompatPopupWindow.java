...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    final class C02381 implements OnScrollChangedListener {
        ...
        C02381(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popupWindow) {
        try {
            ...
            declaredField2.set(popupWindow, new C02381(declaredField, popupWindow, (OnScrollChangedListener) declaredField2.get(popupWindow)));
        } catch (Throwable e) {
