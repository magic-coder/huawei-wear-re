...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (i4 != 0 || i != 0 || i3 != 0 || i2 != 0) {
            ...
            if (i != 0) {
                ...
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, c02431, getRemoveDuration());
                } else {
                    c02431.run();
                }
            }
            if (i2 != 0) {
                ...
                if (i4 != 0) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c02431, getRemoveDuration());
                } else {
                    c02431.run();
                }
            }
            if (i3 != 0) {
                ...
                ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, c02453, removeDuration + Math.max(moveDuration, changeDuration));
            }
        }
    }
    ...
    private void animateAddImpl(final ViewHolder viewHolder) {
        ...
        animate.alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT).setDuration(getAddDuration()).setListener(new VpaListenerAdapter() {
            public void onAnimationStart(View view) {
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            duration.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT).setListener(new VpaListenerAdapter() {
                public void onAnimationStart(View view) {
