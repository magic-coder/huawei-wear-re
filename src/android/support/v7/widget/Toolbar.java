...
public class Toolbar extends ViewGroup {
    ...
    class C02841 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C02841() {
        }
    ...
    public class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C02871();
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuViewItemClickListener = new C02841();
        this.mShowOverflowMenuRunnable = new C02852();
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C02863());
        }
    }
