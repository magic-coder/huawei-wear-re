...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z, int i, int i2) {
        ...
        this.mToolbar.setNavigationOnClickListener(new C02881());
    }
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i, long j) {
        return ViewCompat.animate(this.mToolbar).alpha(i == 0 ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f).setDuration(j).setListener(new ViewPropertyAnimatorListenerAdapter() {
