...
public abstract class OrientationHelper {
    ...
    final class C02561 extends OrientationHelper {
        C02561(LayoutManager layoutManager) {
            super(layoutManager);
        }
    ...
    final class C02572 extends OrientationHelper {
        C02572(LayoutManager layoutManager) {
            super(layoutManager);
        }
