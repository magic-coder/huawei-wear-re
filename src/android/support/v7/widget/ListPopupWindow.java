...
public class ListPopupWindow {
    ...
    class C02553 implements OnItemSelectedListener {
        C02553() {
        }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C02542();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C02553());
            ...
            if (view3 != null) {
                ...
                ViewGroup.LayoutParams layoutParams2 = new LayoutParams(-1, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
