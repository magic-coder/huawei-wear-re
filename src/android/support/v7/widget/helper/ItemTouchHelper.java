...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C02912();
    private View mOverdrawChild = null;
    private int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    private RecyclerView mRecyclerView;
    private final Runnable mScrollRunnable = new C02901();
    ...
    class C02912 implements OnItemTouchListener {
        C02912() {
        }
    ...
    class C02945 implements ChildDrawingOrderCallback {
        C02945() {
        }
    ...
    public abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C02951();
        private static final Interpolator sDragViewScrollCapInterpolator = new C02962();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        final class C02951 implements Interpolator {
            C02951() {
            }
        ...
        final class C02962 implements Interpolator {
            C02962() {
            }
        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c02923 = new RecoverAnimation(viewHolder2, i4, i2, f2, f3, f, signum) {
                        public void onAnimationEnd(ValueAnimatorCompat valueAnimatorCompat) {
                    ...
                    c02923.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, i4, f - f2, signum - f3));
                    this.mRecoverAnimations.add(c02923);
                    c02923.start();
                    obj = 1;
                } else {
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C02945();
            }
