...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C02162();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    private int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C02151();
    ...
    class C02151 implements MainThreadCallback<T> {
        C02151() {
        }
    ...
    class C02162 implements BackgroundCallback<T> {
