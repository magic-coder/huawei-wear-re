...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02121();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02132();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02143();

    class C02121 extends ViewPropertyAnimatorListenerAdapter {
        C02121() {
        }
    ...
    class C02132 extends ViewPropertyAnimatorListenerAdapter {
        C02132() {
        }
    ...
    class C02143 implements ViewPropertyAnimatorUpdateListener {
        C02143() {
        }
