...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C01991();
    ...
    class C02002 implements OnApplyWindowInsetsListener {
        C02002() {
        }
    ...
    class C02013 implements OnFitSystemWindowsListener {
        C02013() {
        }
    ...
    class C02024 implements OnAttachListener {
        C02024() {
        }
    ...
    class C02045 implements Runnable {
        ...
        class C02031 extends ViewPropertyAnimatorListenerAdapter {
            C02031() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C02031());
        }
    }

    class C02056 extends ViewPropertyAnimatorListenerAdapter {
        C02056() {
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C02061());
            }
    ...
    final class PanelFeatureState {
        ...
        class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02071());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            final class C02071 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C02071() {
                }
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view2, new C02002());
                    view = view2;
                } else {
                    ((FitWindowsViewGroup) view2).setOnFitSystemWindowsListener(new C02013());
                    view = view2;
                }
                ...
                this.mDecorContentParent = (DecorContentParent) r0.findViewById(R.id.decor_content_parent);
            ...
            contentFrameLayout.setAttachListener(new C02024());
            return view;
        }
        obtainStyledAttributes.recycle();
        ...
        if (actionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new C02045();
                } else {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C02056());
                    if (this.mActionModePopup != null) {
