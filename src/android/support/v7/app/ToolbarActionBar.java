...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02102();
    private final Runnable mMenuInvalidator = new C02091();
    ...
    class C02102 implements OnMenuItemClickListener {
        C02102() {
        }
