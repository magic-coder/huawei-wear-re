...
final class NTLMEngineImpl implements NTLMEngine {
        ...
        HMACMD5(byte[] bArr) throws NTLMEngineException {
            try {
                ...
                for (length = i; length < 64; length++) {
                    this.ipad[length] = TagName.NOTICE_START_TIME;
                    this.opad[length] = TagName.ORDER_TRADE_STATUSES;
                }
                this.md5.reset();
    ...
    class MD4 {
        protected int f22878A = 1732584193;
        protected int f22879B = -271733879;
        protected int f22880C = -1732584194;
        protected int f22881D = 271733878;
        ...
        byte[] getOutput() {
            ...
            NTLMEngineImpl.writeULong(bArr2, this.f22878A, 0);
            NTLMEngineImpl.writeULong(bArr2, this.f22879B, 4);
            NTLMEngineImpl.writeULong(bArr2, this.f22880C, 8);
            NTLMEngineImpl.writeULong(bArr2, this.f22881D, 12);
            return bArr2;
        }
        ...
        protected void round1(int[] iArr) {
            this.f22878A = NTLMEngineImpl.rotintlft((this.f22878A + NTLMEngineImpl.m29936F(this.f22879B, this.f22880C, this.f22881D)) + iArr[0], 3);
            this.f22881D = NTLMEngineImpl.rotintlft((this.f22881D + NTLMEngineImpl.m29936F(this.f22878A, this.f22879B, this.f22880C)) + iArr[1], 7);
            this.f22880C = NTLMEngineImpl.rotintlft((this.f22880C + NTLMEngineImpl.m29936F(this.f22881D, this.f22878A, this.f22879B)) + iArr[2], 11);
            this.f22879B = NTLMEngineImpl.rotintlft((this.f22879B + NTLMEngineImpl.m29936F(this.f22880C, this.f22881D, this.f22878A)) + iArr[3], 19);
            this.f22878A = NTLMEngineImpl.rotintlft((this.f22878A + NTLMEngineImpl.m29936F(this.f22879B, this.f22880C, this.f22881D)) + iArr[4], 3);
            this.f22881D = NTLMEngineImpl.rotintlft((this.f22881D + NTLMEngineImpl.m29936F(this.f22878A, this.f22879B, this.f22880C)) + iArr[5], 7);
            this.f22880C = NTLMEngineImpl.rotintlft((this.f22880C + NTLMEngineImpl.m29936F(this.f22881D, this.f22878A, this.f22879B)) + iArr[6], 11);
            this.f22879B = NTLMEngineImpl.rotintlft((this.f22879B + NTLMEngineImpl.m29936F(this.f22880C, this.f22881D, this.f22878A)) + iArr[7], 19);
            this.f22878A = NTLMEngineImpl.rotintlft((this.f22878A + NTLMEngineImpl.m29936F(this.f22879B, this.f22880C, this.f22881D)) + iArr[8], 3);
            this.f22881D = NTLMEngineImpl.rotintlft((this.f22881D + NTLMEngineImpl.m29936F(this.f22878A, this.f22879B, this.f22880C)) + iArr[9], 7);
            this.f22880C = NTLMEngineImpl.rotintlft((this.f22880C + NTLMEngineImpl.m29936F(this.f22881D, this.f22878A, this.f22879B)) + iArr[10], 11);
            this.f22879B = NTLMEngineImpl.rotintlft((this.f22879B + NTLMEngineImpl.m29936F(this.f22880C, this.f22881D, this.f22878A)) + iArr[11], 19);
            this.f22878A = NTLMEngineImpl.rotintlft((this.f22878A + NTLMEngineImpl.m29936F(this.f22879B, this.f22880C, this.f22881D)) + iArr[12], 3);
            this.f22881D = NTLMEngineImpl.rotintlft((this.f22881D + NTLMEngineImpl.m29936F(this.f22878A, this.f22879B, this.f22880C)) + iArr[13], 7);
            this.f22880C = NTLMEngineImpl.rotintlft((this.f22880C + NTLMEngineImpl.m29936F(this.f22881D, this.f22878A, this.f22879B)) + iArr[14], 11);
            this.f22879B = NTLMEngineImpl.rotintlft((this.f22879B + NTLMEngineImpl.m29936F(this.f22880C, this.f22881D, this.f22878A)) + iArr[15], 19);
        }

        protected void round2(int[] iArr) {
            this.f22878A = NTLMEngineImpl.rotintlft(((this.f22878A + NTLMEngineImpl.m29937G(this.f22879B, this.f22880C, this.f22881D)) + iArr[0]) + 1518500249, 3);
            this.f22881D = NTLMEngineImpl.rotintlft(((this.f22881D + NTLMEngineImpl.m29937G(this.f22878A, this.f22879B, this.f22880C)) + iArr[4]) + 1518500249, 5);
            this.f22880C = NTLMEngineImpl.rotintlft(((this.f22880C + NTLMEngineImpl.m29937G(this.f22881D, this.f22878A, this.f22879B)) + iArr[8]) + 1518500249, 9);
            this.f22879B = NTLMEngineImpl.rotintlft(((this.f22879B + NTLMEngineImpl.m29937G(this.f22880C, this.f22881D, this.f22878A)) + iArr[12]) + 1518500249, 13);
            this.f22878A = NTLMEngineImpl.rotintlft(((this.f22878A + NTLMEngineImpl.m29937G(this.f22879B, this.f22880C, this.f22881D)) + iArr[1]) + 1518500249, 3);
            this.f22881D = NTLMEngineImpl.rotintlft(((this.f22881D + NTLMEngineImpl.m29937G(this.f22878A, this.f22879B, this.f22880C)) + iArr[5]) + 1518500249, 5);
            this.f22880C = NTLMEngineImpl.rotintlft(((this.f22880C + NTLMEngineImpl.m29937G(this.f22881D, this.f22878A, this.f22879B)) + iArr[9]) + 1518500249, 9);
            this.f22879B = NTLMEngineImpl.rotintlft(((this.f22879B + NTLMEngineImpl.m29937G(this.f22880C, this.f22881D, this.f22878A)) + iArr[13]) + 1518500249, 13);
            this.f22878A = NTLMEngineImpl.rotintlft(((this.f22878A + NTLMEngineImpl.m29937G(this.f22879B, this.f22880C, this.f22881D)) + iArr[2]) + 1518500249, 3);
            this.f22881D = NTLMEngineImpl.rotintlft(((this.f22881D + NTLMEngineImpl.m29937G(this.f22878A, this.f22879B, this.f22880C)) + iArr[6]) + 1518500249, 5);
            this.f22880C = NTLMEngineImpl.rotintlft(((this.f22880C + NTLMEngineImpl.m29937G(this.f22881D, this.f22878A, this.f22879B)) + iArr[10]) + 1518500249, 9);
            this.f22879B = NTLMEngineImpl.rotintlft(((this.f22879B + NTLMEngineImpl.m29937G(this.f22880C, this.f22881D, this.f22878A)) + iArr[14]) + 1518500249, 13);
            this.f22878A = NTLMEngineImpl.rotintlft(((this.f22878A + NTLMEngineImpl.m29937G(this.f22879B, this.f22880C, this.f22881D)) + iArr[3]) + 1518500249, 3);
            this.f22881D = NTLMEngineImpl.rotintlft(((this.f22881D + NTLMEngineImpl.m29937G(this.f22878A, this.f22879B, this.f22880C)) + iArr[7]) + 1518500249, 5);
            this.f22880C = NTLMEngineImpl.rotintlft(((this.f22880C + NTLMEngineImpl.m29937G(this.f22881D, this.f22878A, this.f22879B)) + iArr[11]) + 1518500249, 9);
            this.f22879B = NTLMEngineImpl.rotintlft(((this.f22879B + NTLMEngineImpl.m29937G(this.f22880C, this.f22881D, this.f22878A)) + iArr[15]) + 1518500249, 13);
        }

        protected void round3(int[] iArr) {
            this.f22878A = NTLMEngineImpl.rotintlft(((this.f22878A + NTLMEngineImpl.m29938H(this.f22879B, this.f22880C, this.f22881D)) + iArr[0]) + 1859775393, 3);
            this.f22881D = NTLMEngineImpl.rotintlft(((this.f22881D + NTLMEngineImpl.m29938H(this.f22878A, this.f22879B, this.f22880C)) + iArr[8]) + 1859775393, 9);
            this.f22880C = NTLMEngineImpl.rotintlft(((this.f22880C + NTLMEngineImpl.m29938H(this.f22881D, this.f22878A, this.f22879B)) + iArr[4]) + 1859775393, 11);
            this.f22879B = NTLMEngineImpl.rotintlft(((this.f22879B + NTLMEngineImpl.m29938H(this.f22880C, this.f22881D, this.f22878A)) + iArr[12]) + 1859775393, 15);
            this.f22878A = NTLMEngineImpl.rotintlft(((this.f22878A + NTLMEngineImpl.m29938H(this.f22879B, this.f22880C, this.f22881D)) + iArr[2]) + 1859775393, 3);
            this.f22881D = NTLMEngineImpl.rotintlft(((this.f22881D + NTLMEngineImpl.m29938H(this.f22878A, this.f22879B, this.f22880C)) + iArr[10]) + 1859775393, 9);
            this.f22880C = NTLMEngineImpl.rotintlft(((this.f22880C + NTLMEngineImpl.m29938H(this.f22881D, this.f22878A, this.f22879B)) + iArr[6]) + 1859775393, 11);
            this.f22879B = NTLMEngineImpl.rotintlft(((this.f22879B + NTLMEngineImpl.m29938H(this.f22880C, this.f22881D, this.f22878A)) + iArr[14]) + 1859775393, 15);
            this.f22878A = NTLMEngineImpl.rotintlft(((this.f22878A + NTLMEngineImpl.m29938H(this.f22879B, this.f22880C, this.f22881D)) + iArr[1]) + 1859775393, 3);
            this.f22881D = NTLMEngineImpl.rotintlft(((this.f22881D + NTLMEngineImpl.m29938H(this.f22878A, this.f22879B, this.f22880C)) + iArr[9]) + 1859775393, 9);
            this.f22880C = NTLMEngineImpl.rotintlft(((this.f22880C + NTLMEngineImpl.m29938H(this.f22881D, this.f22878A, this.f22879B)) + iArr[5]) + 1859775393, 11);
            this.f22879B = NTLMEngineImpl.rotintlft(((this.f22879B + NTLMEngineImpl.m29938H(this.f22880C, this.f22881D, this.f22878A)) + iArr[13]) + 1859775393, 15);
            this.f22878A = NTLMEngineImpl.rotintlft(((this.f22878A + NTLMEngineImpl.m29938H(this.f22879B, this.f22880C, this.f22881D)) + iArr[3]) + 1859775393, 3);
            this.f22881D = NTLMEngineImpl.rotintlft(((this.f22881D + NTLMEngineImpl.m29938H(this.f22878A, this.f22879B, this.f22880C)) + iArr[11]) + 1859775393, 9);
            this.f22880C = NTLMEngineImpl.rotintlft(((this.f22880C + NTLMEngineImpl.m29938H(this.f22881D, this.f22878A, this.f22879B)) + iArr[7]) + 1859775393, 11);
            this.f22879B = NTLMEngineImpl.rotintlft(((this.f22879B + NTLMEngineImpl.m29938H(this.f22880C, this.f22881D, this.f22878A)) + iArr[15]) + 1859775393, 15);
        }
    }
    ...
    static {
        ...
        Object bytes = EncodingUtils.getBytes("NTLMSSP", DEFAULT_CHARSET);
    ...
    static int m29936F(int i, int i2, int i3) {
        return (i & i2) | ((i ^ -1) & i3);
    }

    static int m29937G(int i, int i2, int i3) {
        return ((i & i2) | (i & i3)) | (i2 & i3);
    }

    static int m29938H(int i, int i2, int i3) {
        return (i ^ i2) ^ i3;
    }
