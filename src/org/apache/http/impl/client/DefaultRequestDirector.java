        ...
        while (obj == null) {
            try {
                ...
                try {
                    ...
                    httpContext.setAttribute("http.target_host", obj2);
                    ...
                    if (tryExecute == null) {
                        ...
                        if (z) {
                            ...
                            if (this.log.isDebugEnabled()) {
                                if (keepAliveDuration > 0) {
                                    userInfo = "for " + keepAliveDuration + HwAccountConstants.BLANK + TimeUnit.MILLISECONDS;
                                } else {
                        ...
                        if (this.managedConn != null) {
                            if (attribute == null) {
                                obj2 = this.userTokenHandler.getUserToken(httpContext);
                                httpContext.setAttribute(ClientContext.USER_TOKEN, obj2);
                            } else {
                                obj2 = attribute;
                            }
                            if (obj2 != null) {
                                this.managedConn.setState(obj2);
                            }
                        }
                        httpResponse = tryExecute;
                    }
