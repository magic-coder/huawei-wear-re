...
public class WalletTaException extends Exception {
    ...
    public class WalletTaAccountNotExistException extends WalletTaException {
    }

    public class WalletTaBadParammeterException extends WalletTaException {
    }

    public class WalletTaCardAlreadyExistException extends WalletTaException {
    }

    public class WalletTaCardNotExistException extends WalletTaException {
    }

    public class WalletTaCardNumReachMaxException extends WalletTaException {
    }

    public class WalletTaDefaultCardNotExistException extends WalletTaException {
    }

    public class WalletTaFingerIdMismatchException extends WalletTaException {
    }

    public class WalletTaFingerIdNotExistException extends WalletTaException {
    }

    public class WalletTaItemNotExistException extends WalletTaException {
    }

    public class WalletTaSystemErrorException extends WalletTaException {
        public WalletTaSystemErrorException(long j) {
            super(j);
        }
    }

    public WalletTaException(long j) {
        this.code = j;
    }
    ...
    public WalletTaSystemErrorException newWalletTaSystemErrorException(long j) {
        return new WalletTaSystemErrorException(j);
    }
