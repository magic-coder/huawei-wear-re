...
public interface IRemoteServiceCallback extends IInterface {
    ...
    public abstract class Stub extends Binder implements IRemoteServiceCallback {
        private static final String DESCRIPTOR = "com.huawei.android.hwpay.service.IRemoteServiceCallback";
        ...
        public static IRemoteServiceCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IRemoteServiceCallback)) ? new C4034a(iBinder) : (IRemoteServiceCallback) queryLocalInterface;
        }
