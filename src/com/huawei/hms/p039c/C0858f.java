...
public final class C0858f {
    public static byte[] m3022a(byte[] bArr) {
        try {
            return MessageDigest.getInstance("SHA-256").digest(bArr);
        } catch (NoSuchAlgorithmException e) {
            C0887a.m3098d("SHA256", "NoSuchAlgorithmException" + e.getMessage());
            return new byte[0];
        }
    }
    ...
    public static byte[] m3021a(java.io.File r8) {
        /*
        r2 = 0;
        r0 = 0;
        r1 = "SHA-256";
    ...
    L_0x0026:
        ...
        com.huawei.hms.support.log.C0887a.m3098d(r0, r3);	 Catch:{ all -> 0x004a }
        com.huawei.hms.p039c.C0854c.m3009a(r1);
    L_0x0031:
        r0 = new byte[r2];
    L_0x0033:
        return r0;
