...
public final class C6344c<K, V> {
    private int f22085A;
    private int f22086B;
    private int f22087C;
    private int f22088D;
    private int size;
    private final LinkedHashMap<K, V> f22089u;
    private int f22090v;
    ...
    L_0x0005:
        r0 = r3.f22089u;	 Catch:{ all -> 0x0032 }
    ...
    L_0x0043:
        ...
        r0 = r3.f22086B;	 Catch:{ all -> 0x0032 }
        r0 = r0 + 1;
        r3.f22086B = r0;	 Catch:{ all -> 0x0032 }
        monitor-exit(r3);	 Catch:{ all -> 0x0032 }
        goto L_0x0000;
        */
    ...
    public final synchronized boolean m29041a(K k) {
        return this.f22089u.containsKey(k);
    }
    ...
    public final V put(K k, V v) {
        ...
        synchronized (this) {
            this.f22085A++;
            this.size++;
            put = this.f22089u.put(k, v);
            if (put != null) {
                this.size--;
            }
        }
        trimToSize(this.f22090v);
        return put;
    }
    ...
    public final synchronized String toString() {
        ...
        int i = 0;
        synchronized (this) {
            int i2 = this.f22087C + this.f22088D;
            if (i2 != 0) {
                i = (this.f22087C * 100) / i2;
            }
            format = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.f22090v), Integer.valueOf(this.f22087C), Integer.valueOf(this.f22088D), Integer.valueOf(i)});
        }
        return format;
    }
}
