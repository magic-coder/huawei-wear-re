...
public class C6400m implements X509TrustManager {
    X509TrustManager f22237a;

    C6400m() throws Exception {
        KeyStore instance;
        Throwable th;
        ...
        for (int i = 0; i < trustManagers.length; i++) {
            if (trustManagers[i] instanceof X509TrustManager) {
                this.f22237a = (X509TrustManager) trustManagers[i];
                return;
            }
        }
    ...
    public void checkClientTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        this.f22237a.checkClientTrusted(x509CertificateArr, str);
    }

    public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        this.f22237a.checkServerTrusted(x509CertificateArr, str);
    }

    public X509Certificate[] getAcceptedIssuers() {
        return this.f22237a.getAcceptedIssuers();
    }
}
