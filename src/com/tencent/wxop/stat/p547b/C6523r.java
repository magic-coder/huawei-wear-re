...
public final class C6523r {
    ...
    public static String m29783a(Context context) {
        try {
    ...
    public static String m29784a(String str) {
        if (str == null) {
            return null;
        }
        ...
        try {
            return new String(C6512g.m29722b(C6513h.m29723a(str.getBytes(GameManager.DEFAULT_CHARSET))), GameManager.DEFAULT_CHARSET);
        } catch (Throwable th) {
    ...
    public static void m29785a(JSONObject jSONObject, String str, String str2) {
        if (str2 != null) {
            try {
                if (str2.length() > 0) {
    ...
    public static boolean m29786a(Context context, String str) {
        try {
    ...
    public static String m29787b(Context context) {
    ...
    public static String m29788b(String str) {
        if (str == null) {
            return null;
        }
        if (VERSION.SDK_INT < 8) {
        ...
        try {
            return new String(C6513h.m29724b(C6512g.m29720a(str.getBytes(GameManager.DEFAULT_CHARSET))), GameManager.DEFAULT_CHARSET);
        } catch (Throwable th) {
    ...
    public static String m29789c(Context context) {
        try {
            WifiInfo g = C6523r.m29793g(context);
            if (g != null) {
                return g.getBSSID();
            }
        } catch (Throwable th) {
    ...
    public static String m29790d(Context context) {
        try {
            WifiInfo g = C6523r.m29793g(context);
            if (g != null) {
                return g.getSSID();
    ...
    public static boolean m29791e(Context context) {
        try {
    ...
    public static JSONArray m29792f(Context context) {
        try {
            if (C6523r.m29786a(context, "android.permission.INTERNET") && C6523r.m29786a(context, "android.permission.ACCESS_NETWORK_STATE")) {
                WifiManager wifiManager = (WifiManager) context.getSystemService("wifi");
                if (wifiManager != null) {
                    ...
                    if (scanResults != null && scanResults.size() > 0) {
                        Collections.sort(scanResults, new C6524s());
    ...
    private static WifiInfo m29793g(Context context) {
        if (C6523r.m29786a(context, "android.permission.ACCESS_WIFI_STATE")) {
