...
public class AesEncrypt {
    public static String Encrypt(String str) {
        try {
            ...
            LogUtil.m28662e("Encrypt", e.getMessage());
            return null;
        }
    }
    ...
    public static String Decrypt(String str) {
        try {
            ...
            try {
                ...
                LogUtil.m28662e("Decrypt", e.getMessage());
                return null;
            }
        } catch (Exception e2) {
            LogUtil.m28662e("Decrypt", e2.getMessage());
            return null;
        }
    }
    ...
    protected static Key generateKey(String str) {
        try {
            ...
            if (substring == null) {
                LogUtil.m28664v("Decrypt", "Key为空null");
                return null;
            } else if (substring.length() == 16) {
                return new SecretKeySpec(substring.getBytes("utf-8"), "AES");
            } else {
                LogUtil.m28664v("Decrypt", "Key长度不是16位");
                return null;
            }
        } catch (Exception e) {
            LogUtil.m28662e("generateKey", e.getMessage());
            return null;
        }
    }
