...
public class MobileRegisterActivity extends Activity implements OnClickListener, OnFocusChangeListener, SizeChangeListener {
    ...
    class C62182 implements ListenerOnTitleBtnClicked {
        C62182() {
        }
    ...
    class C62193 implements RequestListener {
        C62193() {
        }

        public void onWeiboException(WeiboException weiboException) {
            LogUtil.m28661d(MobileRegisterActivity.TAG, "get onWeiboException " + weiboException.getMessage());
        ...
        public void onComplete(String str) {
            LogUtil.m28661d(MobileRegisterActivity.TAG, "get onComplete : " + str);
            if (str != null) {
                try {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        initView();
        this.mCountDownTimer = new CountDownTimer(FileWatchdog.DEFAULT_DELAY, 1000) {
    ...
    private void initView() {
        ...
        this.titleBar.setTitleBarClickListener(new C62182());
    ...
    public void getMsg(String str, String str2) {
        ...
        NetUtils.internalHttpRequest(this, SEND_MSG, weiboParameters, HttpGet.METHOD_NAME, new C62193());
    }
    ...
    public void submit(final String str, String str2) {
        ...
        NetUtils.internalHttpRequest(this, SEND_SUBMIT, weiboParameters, HttpGet.METHOD_NAME, new RequestListener() {
            public void onWeiboException(WeiboException weiboException) {
                LogUtil.m28661d(MobileRegisterActivity.TAG, "get onWeiboException " + weiboException.getMessage());
                CharSequence string = ResourceManager.getString(MobileRegisterActivity.this.getApplicationContext(), MobileRegisterActivity.SERVER_ERROR_EN, MobileRegisterActivity.SERVER_ERROR_CN, MobileRegisterActivity.SERVER_ERROR_TW);
                try {
