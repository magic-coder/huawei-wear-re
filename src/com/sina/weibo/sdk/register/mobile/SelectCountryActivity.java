...
public class SelectCountryActivity extends Activity implements OnIndexChangeListener {
    ...
    class C62211 implements ListenerOnTitleBtnClicked {
        C62211() {
        }
    ...
    class C62222 implements OnItemClickListener {
        C62222() {
        }
    ...
    private void initView() {
        ...
        titleBar.setTitleBarClickListener(new C62211());
        ...
        this.mListView.setOnItemClickListener(new C62222());
