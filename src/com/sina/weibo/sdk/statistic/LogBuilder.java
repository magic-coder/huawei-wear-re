...
class LogBuilder {
    ...
    public static String getAppKey(Context context) {
        try {
            ...
            if (applicationInfo != null) {
                ...
                if (obj != null) {
                    LogUtil.m28663i(WBAgent.TAG, "APPKEY: " + String.valueOf(obj));
                    return String.valueOf(obj);
                }
                LogUtil.m28662e(WBAgent.TAG, "Could not read WEIBO_APPKEY meta-data from AndroidManifest.xml.");
            }
        } catch (Exception e) {
            LogUtil.m28662e(WBAgent.TAG, "Could not read WEIBO_APPKEY meta-data from AndroidManifest.xml." + e);
        }
        return null;
    }
    ...
    public static String getChannel(Context context) {
        try {
            ...
            if (applicationInfo != null) {
                ...
                if (string != null) {
                    LogUtil.m28663i(WBAgent.TAG, "CHANNEL: " + string.trim());
                    return string.trim();
                }
                LogUtil.m28662e(WBAgent.TAG, "Could not read WEIBO_CHANNEL meta-data from AndroidManifest.xml.");
            }
        } catch (Exception e) {
            LogUtil.m28662e(WBAgent.TAG, "Could not read WEIBO_CHANNEL meta-data from AndroidManifest.xml." + e);
        }
        return null;
    }
    ...
    public static String getVersion(Context context) {
        try {
            ...
            LogUtil.m28663i(WBAgent.TAG, "versionName: " + packageInfo.versionName);
            return packageInfo.versionName;
        } catch (NameNotFoundException e) {
            LogUtil.m28662e(WBAgent.TAG, "Could not read versionName from AndroidManifest.xml." + e);
            return null;
        }
    }
    ...
    private static org.json.JSONObject getLogInfo(com.sina.weibo.sdk.statistic.PageLog r6) {
        ...
        r1.<init>();
        r0 = $SWITCH_TABLE$com$sina$weibo$sdk$statistic$LogType();	 Catch:{ Exception -> 0x002c }
        r2 = r6.getType();	 Catch:{ Exception -> 0x002c }
    ...
    L_0x0017:
        r0 = "type";
        r2 = 0;
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002c }
        r0 = "time";
        r2 = r6.getStartTime();	 Catch:{ Exception -> 0x002c }
    ...
    L_0x002c:
        ...
        r0 = r3.append(r0);
        r0 = r0.toString();
        com.sina.weibo.sdk.utils.LogUtil.m28662e(r2, r0);
        goto L_0x0016;
    L_0x0042:
        r0 = "type";
        r2 = 1;
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002c }
        r0 = "time";
        r2 = r6.getEndTime();	 Catch:{ Exception -> 0x002c }
        r4 = 1000; // 0x3e8 float:1.401E-42 double:4.94E-321;
        r2 = r2 / r4;
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002c }
        r0 = "duration";
        r2 = r6.getDuration();	 Catch:{ Exception -> 0x002c }
        r4 = 1000; // 0x3e8 float:1.401E-42 double:4.94E-321;
        r2 = r2 / r4;
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002c }
        goto L_0x0016;
    L_0x0063:
        ...
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002c }
        r0 = "page_id";
        r2 = r6.getPage_id();	 Catch:{ Exception -> 0x002c }
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002c }
        r0 = "time";
        r2 = r6.getStartTime();	 Catch:{ Exception -> 0x002c }
        r4 = 1000; // 0x3e8 float:1.401E-42 double:4.94E-321;
    ...
    L_0x008d:
        ...
        r2 = r2 / r4;
        r1.put(r0, r2);	 Catch:{ Exception -> 0x002c }
        r6 = (com.sina.weibo.sdk.statistic.EventLog) r6;	 Catch:{ Exception -> 0x002c }
        addEventData(r1, r6);	 Catch:{ Exception -> 0x002c }
        goto L_0x0016;
    L_0x00b1:
        r0 = "type";
        r2 = 4;
    ...
    private static JSONObject addEventData(JSONObject jSONObject, EventLog eventLog) {
        try {
            ...
            LogUtil.m28662e(WBAgent.TAG, "add event log error." + e);
        }
        return jSONObject;
    }
