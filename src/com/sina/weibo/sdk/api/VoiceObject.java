...
public class VoiceObject extends BaseMediaObject {
    public static final Creator<VoiceObject> CREATOR = new C61981();
    ...
    class C61981 implements Creator<VoiceObject> {
        C61981() {
        }
    ...
    public boolean checkArgs() {
        ...
        if (this.dataUrl != null && this.dataUrl.length() > 512) {
            LogUtil.m28662e("Weibo.VoiceObject", "checkArgs fail, dataUrl is invalid");
            return false;
        } else if (this.dataHdUrl != null && this.dataHdUrl.length() > 512) {
            LogUtil.m28662e("Weibo.VoiceObject", "checkArgs fail, dataHdUrl is invalid");
            return false;
        } else if (this.duration > 0) {
            return true;
        } else {
            LogUtil.m28662e("Weibo.VoiceObject", "checkArgs fail, duration is invalid");
            return false;
        }
    }
