...
public class TextObject extends BaseMediaObject {
    public static final Creator<TextObject> CREATOR = new C61961();
    public String text;

    class C61961 implements Creator<TextObject> {
        C61961() {
        }
    ...
    public boolean checkArgs() {
        ...
        LogUtil.m28662e("Weibo.TextObject", "checkArgs fail, text is invalid");
        return false;
    }
