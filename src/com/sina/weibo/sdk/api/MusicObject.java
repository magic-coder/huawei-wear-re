...
public class MusicObject extends BaseMediaObject {
    public static final Creator<MusicObject> CREATOR = new C61951();
    ...
    class C61951 implements Creator<MusicObject> {
        C61951() {
        }
    ...
    public boolean checkArgs() {
        ...
        if (this.dataUrl != null && this.dataUrl.length() > 512) {
            LogUtil.m28662e("Weibo.MusicObject", "checkArgs fail, dataUrl is invalid");
            return false;
        } else if (this.dataHdUrl != null && this.dataHdUrl.length() > 512) {
            LogUtil.m28662e("Weibo.MusicObject", "checkArgs fail, dataHdUrl is invalid");
            return false;
        } else if (this.duration > 0) {
            return true;
        } else {
            LogUtil.m28662e("Weibo.MusicObject", "checkArgs fail, duration is invalid");
            return false;
        }
    }
