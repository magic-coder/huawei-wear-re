...
public class WeiboSdkBrowser extends Activity implements BrowserRequestCallBack {
    ...
    class C62062 implements OnClickListener {
        C62062() {
        }
    ...
    class C62073 implements OnClickListener {
        C62073() {
        }
    ...
    private boolean initDataFromIntent(Intent intent) {
        ...
        LogUtil.m28661d(TAG, "LOAD URL : " + this.mUrl);
        return true;
    }
    ...
    private void startShare() {
        LogUtil.m28661d(TAG, "Enter startShare()............");
        final ShareRequestParam shareRequestParam = (ShareRequestParam) this.mRequestParam;
        if (shareRequestParam.hasImage()) {
            LogUtil.m28661d(TAG, "loadUrl hasImage............");
            new AsyncWeiboRunner(this).requestAsync(ShareRequestParam.UPLOAD_PIC_URL, shareRequestParam.buildUploadPicParam(new WeiboParameters(shareRequestParam.getAppKey())), HttpPost.METHOD_NAME, new RequestListener() {
                public void onWeiboException(WeiboException weiboException) {
                    LogUtil.m28661d(WeiboSdkBrowser.TAG, "post onWeiboException " + weiboException.getMessage());
                    shareRequestParam.sendSdkErrorResponse(WeiboSdkBrowser.this, weiboException.getMessage());
                    WeiboSdkBrowser.this.finish();
                }

                public void onComplete(String str) {
                    LogUtil.m28661d(WeiboSdkBrowser.TAG, "post onComplete : " + str);
    ...
    private void setTopNavTitle() {
        ...
        this.mLeftBtn.setOnClickListener(new C62062());
    }
    ...
    private void setContentView() {
        ...
        this.mLoadErrorRetryBtn.setOnClickListener(new C62073());
    ...
    private View initTitleBar() {
        ...
        this.mTitleText.setMaxWidth(ResourceManager.dp2px(this, SyslogAppender.LOG_LOCAL4));
    ...
    public void onPageStartedCallBack(WebView webView, String str, Bitmap bitmap) {
        LogUtil.m28661d(TAG, "onPageStarted URL: " + str);
        this.mUrl = str;
    ...
    public boolean shouldOverrideUrlLoadingCallBack(WebView webView, String str) {
        LogUtil.m28663i(TAG, "shouldOverrideUrlLoading URL: " + str);
        return false;
    }

    public void onPageFinishedCallBack(WebView webView, String str) {
        LogUtil.m28661d(TAG, "onPageFinished URL: " + str);
        if (this.isErrorPage) {
            promptError();
            return;
        }
    ...
    public void onReceivedErrorCallBack(WebView webView, int i, String str, String str2) {
        LogUtil.m28661d(TAG, "onReceivedError: errorCode = " + i + ", description = " + str + ", failingUrl = " + str2);
    ...
    public void onReceivedSslErrorCallBack(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
        LogUtil.m28661d(TAG, "onReceivedSslErrorCallBack.........");
    }
    ...
    public void removeJavascriptInterface(WebView webView) {
        if (VERSION.SDK_INT < 11) {
            try {
                ...
                LogUtil.m28662e(TAG, e.toString());
            }
        }
    }
}
