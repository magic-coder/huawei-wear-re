...
public class AttentionComponentView extends FrameLayout {
    ...
    class C62081 implements OnClickListener {
        C62081() {
        }
    ...
    class C62102 implements RequestListener {
        C62102() {
        }

        public void onWeiboException(WeiboException weiboException) {
            LogUtil.m28661d(AttentionComponentView.TAG, "error : " + weiboException.getMessage());
            AttentionComponentView.this.mIsLoadingState = false;
        }

        public void onComplete(String str) {
            LogUtil.m28661d(AttentionComponentView.TAG, "json : " + str);
            try {
    ...
    class C62113 implements WidgetRequestCallback {
        C62113() {
        }

        public void onWebViewResult(String str) {
            Object string = Utility.parseUri(str).getString("result");
    ...
    private void init(Context context) {
        ...
        this.flButton.setOnClickListener(new C62081());
    ...
    private void loadAttentionState(RequestParam requestParam) {
        if (!this.mIsLoadingState) {
            ...
            NetUtils.internalHttpRequest(getContext(), FRIENDSHIPS_SHOW_URL, weiboParameters, HttpGet.METHOD_NAME, new C62102());
        }
    }
    ...
    private void execAttented() {
        ...
        widgetRequestParam.setWidgetRequestCallback(new C62113());
