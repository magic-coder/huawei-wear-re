...
public class TitleBar extends RelativeLayout {
    ...
    class C62141 implements OnClickListener {
        C62141() {
        }
    ...
    private void initViews() {
        ...
        this.mLeftBtn.setOnClickListener(new C62141());
        ...
        this.mTitleText.setMaxWidth(ResourceManager.dp2px(getContext(), SyslogAppender.LOG_LOCAL4));
