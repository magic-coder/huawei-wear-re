...
public class WBConstants {
    public static final String ACTION_LOG_TYPE_MESSAGE = "message";
    public static final String ACTION_LOG_TYPE_PAY = "pay";
    public static final String ACTION_LOG_TYPE_SHARE = "share";
    public static final String ACTION_LOG_TYPE_SSO = "sso";
