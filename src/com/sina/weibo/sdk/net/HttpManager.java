...
public class HttpManager {
    ...
    class C62151 implements RedirectHandler {
        C62151() {
        }

        public boolean isRedirectRequested(HttpResponse httpResponse, HttpContext httpContext) {
            LogUtil.m28661d(HttpManager.TAG, "openUrl4RdirectURL isRedirectRequested method");
            return false;
        }

        public URI getLocationURI(HttpResponse httpResponse, HttpContext httpContext) throws ProtocolException {
            LogUtil.m28661d(HttpManager.TAG, "openUrl4RdirectURL getLocationURI method");
            return null;
        }
    }

    class C62162 extends CustomRedirectHandler {
        C62162() {
        }
    ...
    public static String openUrl(Context context, String str, String str2, WeiboParameters weiboParameters) throws WeiboException {
        ...
        LogUtil.m28661d(TAG, "Response : " + readRsponse);
        return readRsponse;
    }
    ...
    private static HttpResponse requestHttpExecute(Context context, String str, String str2, WeiboParameters weiboParameters) {
        ...
        try {
            ...
            try {
                ...
                newHttpClient.getParams().setParameter(ConnRoutePNames.DEFAULT_PROXY, NetStateManager.getAPN());
                setHttpCommonParam(context, weiboParameters);
                if (str2.equals("GET")) {
                    String stringBuilder = new StringBuilder(String.valueOf(str)).append(LocationInfo.NA).append(weiboParameters.encodeUrl()).toString();
                    httpGet = new HttpGet(stringBuilder);
                    LogUtil.m28661d(TAG, "requestHttpExecute GET Url : " + stringBuilder);
                } else if (str2.equals("POST")) {
                    LogUtil.m28661d(TAG, "requestHttpExecute POST Url : " + str);
                    ...
                    try {
                        ...
                        if (weiboParameters.hasBinaryData()) {
                            ...
                            LogUtil.m28661d(TAG, "requestHttpExecute POST postParam : " + encodeUrl);
    ...
    public static String openUrl4RdirectURL(Context context, String str, String str2, WeiboParameters weiboParameters) throws WeiboException {
        ...
        try {
            ...
            try {
                HttpUriRequest httpGet;
                defaultHttpClient.setRedirectHandler(new C62151());
                setHttpCommonParam(context, weiboParameters);
                defaultHttpClient.getParams().setParameter(ConnRoutePNames.DEFAULT_PROXY, NetStateManager.getAPN());
                if (str2.equals("GET")) {
                    String stringBuilder = new StringBuilder(String.valueOf(str)).append(LocationInfo.NA).append(weiboParameters.encodeUrl()).toString();
                    LogUtil.m28661d(TAG, "openUrl4RdirectURL GET url : " + stringBuilder);
                    httpGet = new HttpGet(stringBuilder);
                } else if (str2.equals("POST")) {
                    httpGet = new HttpPost(str);
                    LogUtil.m28661d(TAG, "openUrl4RdirectURL POST url : " + str);
                }
                HttpResponse execute = defaultHttpClient.execute(httpGet);
                int statusCode = execute.getStatusLine().getStatusCode();
                String value;
                if (statusCode == 301 || statusCode == HttpStatus.SC_MOVED_TEMPORARILY) {
                    value = execute.getFirstHeader("Location").getValue();
                    LogUtil.m28661d(TAG, "RedirectURL = " + value);
    ...
    public static String openRedirectUrl4LocationUri(Context context, String str, String str2, WeiboParameters weiboParameters) {
        ...
        HttpClient httpClient = null;
        try {
            Object c62162 = new C62162();
            DefaultHttpClient defaultHttpClient = (DefaultHttpClient) getNewHttpClient();
            try {
                HttpUriRequest httpGet;
                defaultHttpClient.setRedirectHandler(c62162);
                setHttpCommonParam(context, weiboParameters);
                defaultHttpClient.getParams().setParameter(ConnRoutePNames.DEFAULT_PROXY, NetStateManager.getAPN());
                if (str2.equals("GET")) {
                    httpGet = new HttpGet(new StringBuilder(String.valueOf(str)).append(LocationInfo.NA).append(weiboParameters.encodeUrl()).toString());
                } else if (str2.equals("POST")) {
                    httpGet = new HttpPost(str);
                }
                httpGet.setHeader("User-Agent", NetworkHelper.generateUA(context));
                defaultHttpClient.execute(httpGet);
                String redirectUrl = c62162.getRedirectUrl();
                shutdownHttpClient(defaultHttpClient);
                return redirectUrl;
            } catch (Throwable e) {
                th = e;
        ...
        if (httpResponse != null) {
            ...
            try {
                ...
                try {
                    ...
                    LogUtil.m28661d(TAG, "readRsponse result : " + str);
                    if (content != null) {
                        try {
                            content.close();
                        } catch (IOException e2) {
    ...
    private static SSLSocketFactory getSSLSocketFactory() {
        if (sSSLSocketFactory == null) {
            try {
                ...
                LogUtil.m28661d(TAG, "getSSLSocketFactory noraml !!!!!");
            } catch (Exception e) {
                e.printStackTrace();
                sSSLSocketFactory = SSLSocketFactory.getSocketFactory();
                LogUtil.m28661d(TAG, "getSSLSocketFactory error default !!!!!");
            }
        }
