...
class AppInstallCmdExecutor implements CmdExecutor<AppInstallCmd> {
    ...
    final class NOTIFICATION_CONSTANTS {
...
*/
    ...
    L_0x0048:
        ...
        r2 = generateSaveFileName(r0);	 Catch:{ WeiboException -> 0x0091, all -> 0x00a2 }
    ...
    L_0x006b:
        ...
        com.sina.weibo.sdk.utils.LogUtil.m28662e(r0, r1);	 Catch:{ WeiboException -> 0x0091, all -> 0x00a2 }
    ...
    public void stop() {
        if (this.thread == null || this.mHandler == null) {
            LogUtil.m28665w(TAG, "no thread running. please call start method first!");
            return;
        }
