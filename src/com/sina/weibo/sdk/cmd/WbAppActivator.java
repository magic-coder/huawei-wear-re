...
public class WbAppActivator {
    ...
    public void activateApp() {
        ...
        if (System.currentTimeMillis() - FrequencyHelper.getLastTime(this.mContext, weiboSdkSp) < FrequencyHelper.getFrequency(this.mContext, weiboSdkSp)) {
            LogUtil.m28664v(TAG, String.format("it's only %d ms from last time get cmd", new Object[]{Long.valueOf(r4)}));
            return;
        }
        new Thread(new Runnable() {
            public void run() {
                ...
                Throwable th;
                LogUtil.m28664v(WbAppActivator.TAG, "mLock.isLocked()--->" + WbAppActivator.this.mLock.isLocked());
                if (WbAppActivator.this.mLock.tryLock()) {
                    ...
                    try {
                        ...
                        if (access$4 != null) {
                            cmdInfo2 = new CmdInfo(AesEncrypt.Decrypt(access$4));
                            try {
                                ...
                                try {
                                    LogUtil.m28662e(WbAppActivator.TAG, weiboException.getMessage());
    ...
    private static String requestCmdInfo(Context context, String str) {
        ...
        return NetUtils.internalHttpRequest(context, "http://api.weibo.cn/2/client/common_config", HttpGet.METHOD_NAME, weiboParameters);
    }
