...
public class WTaskCardSwitch implements IWalletServiceTask {
    ...
    public String executeTask(TaskParam taskParam) throws SnowballException {
        ...
        int switchCard = new BusinessCardSetDefault(0).switchCard(taskParam.getContext(), taskParam.getInputParam());
        taskResult.setResult_code(switchCard + "");
        if (switchCard == 0) {
