...
public class ImageLoader {
    ...
    class C03094 implements Runnable {
        C03094() {
        }
    ...
    public static ImageListener getImageListener(ImageView imageView, int i, int i2) {
        return new C03061(i2, imageView, i);
    }
