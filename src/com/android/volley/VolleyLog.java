...
public class VolleyLog {
    ...
    class MarkerLog {
        ...
        public synchronized void finish(String str) {
            ...
            if (getTotalDuration() > 0) {
                ...
                VolleyLog.m123d("(%-4d ms) %s", Long.valueOf(r2), str);
                long j2 = j;
                for (Marker marker : this.mMarkers) {
                    VolleyLog.m123d("(+%-4d) [%2d] %s", Long.valueOf(marker.time - j2), Long.valueOf(marker.thread), marker.name);
                    j2 = marker.time;
                }
            }
        }
        ...
        protected void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m124e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
    ...
    public static void setTag(String str) {
        m123d("Changing log tag to %s", str);
        TAG = str;
        DEBUG = Log.isLoggable(TAG, 2);
    }

    public static void m126v(String str, Object... objArr) {
        if (DEBUG) {
            Log.v(TAG, buildMessage(str, objArr));
        }
    }

    public static void m123d(String str, Object... objArr) {
        Log.d(TAG, buildMessage(str, objArr));
    }

    public static void m124e(String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr));
    }

    public static void m125e(Throwable th, String str, Object... objArr) {
