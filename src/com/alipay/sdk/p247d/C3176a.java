...
public final class C3176a {
    ...
    public final void m14032a() {
        if (this.f10581c != null) {
            this.f10581c.runOnUiThread(new C3178c(this));
        }
    }

    public final void m14033b() {
        if (this.f10581c != null) {
            this.f10581c.runOnUiThread(new C3179d(this));
        }
    }
}
