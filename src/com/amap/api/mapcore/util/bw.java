...
/* compiled from: Utils */
public class bw {
    public static boolean m15802a(JSONObject jSONObject, String str) {
        return jSONObject != null && jSONObject.has(str);
    }

    public static byte[] m15803a() {
        int i = 0;
        try {
            ...
            split = new StringBuffer(new String(br.m15752b(new String(bArr)))).reverse().toString().split(",");
            ...
            cd.m15825a(th, "Utils", "getIV");
            return new byte[16];
        }
    }

    static String m15800a(Map<String, String> map) {
        if (map == null) {
            return null;
        }
    ...
    public static String m15799a(Throwable th) {
        Writer stringWriter;
    ...
    public static String m15805b(Map<String, String> map) {
        return m15798a(m15800a((Map) map));
    }

    public static String m15798a(String str) {
        try {
            ...
            cd.m15825a(th, "Utils", "sortParams");
        }
    }

    public static byte[] m15804a(byte[] bArr) {
        try {
            return m15810f(bArr);
        } catch (Throwable e) {
            cd.m15825a(e, "Utils", "gZip");
            return new byte[0];
        } catch (Throwable e2) {
            cd.m15825a(e2, "Utils", "gZip");
            return new byte[0];
        }
    }

    public static byte[] m15806b(byte[] bArr) {
    ...
    static java.security.PublicKey m15801a(android.content.Context r5) throws java.security.cert.CertificateException, java.security.spec.InvalidKeySpecException, java.security.NoSuchAlgorithmException, java.lang.NullPointerException, java.io.IOException {
        /*
        r0 = 0;
    ...
    L_0x004e:
        ...
        goto L_0x003d;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.bw.a(android.content.Context):java.security.PublicKey");
    }

    static String m15807c(byte[] bArr) {
        try {
            return m15809e(bArr);
        } catch (Throwable th) {
            cd.m15825a(th, "Utils", "HexString");
            return null;
        }
    }

    static String m15808d(byte[] bArr) {
        try {
            return m15809e(bArr);
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public static String m15809e(byte[] bArr) {
        StringBuilder stringBuilder = new StringBuilder();
        if (bArr == null) {
            return null;
        }
    ...
    private static byte[] m15810f(byte[] bArr) throws IOException, Throwable {
        ByteArrayOutputStream byteArrayOutputStream;
