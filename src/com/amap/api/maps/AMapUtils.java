...
public class AMapUtils {
    ...
    class C3364a extends Thread {
        String f11970a = "";
        Context f11971b;

        public C3364a(String str, Context context) {
            this.f11970a = str;
            if (context != null) {
        ...
        public void run() {
            if (this.f11971b != null) {
                try {
                    bn.m15698b(this.f11971b, new C3299a(this.f11970a, "3.2.0.1", C3264r.f11368d).m15789a(new String[]{"com.amap.api.maps"}).m15790a());
                    interrupt();
                } catch (bl e) {
                    e.printStackTrace();
                }
    ...
    public static void openAMapNavi(NaviPara naviPara, Context context) throws AMapException {
        if (!m16432a(context)) {
            ...
            try {
                ...
                intent.addFlags(276824064);
                intent.addCategory("android.intent.category.DEFAULT");
                intent.setData(Uri.parse(m16429a(naviPara, context)));
                intent.setPackage("com.autonavi.minimap");
                new C3364a("oan", context).start();
                context.startActivity(intent);
            } catch (Throwable th) {
    ...
    public static void openAMapPoiNearbySearch(PoiPara poiPara, Context context) throws AMapException {
        if (!m16432a(context)) {
            ...
            try {
                ...
                intent.addFlags(276824064);
                intent.addCategory("android.intent.category.DEFAULT");
                intent.setData(Uri.parse(m16430a(poiPara, context)));
                intent.setPackage("com.autonavi.minimap");
                new C3364a("oan", context).start();
                context.startActivity(intent);
            } catch (Throwable th) {
    ...
    public static void openAMapDrivingRoute(RoutePara routePara, Context context) throws AMapException {
        m16431a(routePara, context, 2);
    }

    public static void openAMapTransitRoute(RoutePara routePara, Context context) throws AMapException {
        m16431a(routePara, context, 1);
    }

    public static void openAMapWalkingRoute(RoutePara routePara, Context context) throws AMapException {
        m16431a(routePara, context, 4);
    }

    private static void m16431a(RoutePara routePara, Context context, int i) throws AMapException {
        if (!m16432a(context)) {
            throw new AMapException(AMapException.AMAP_NOT_SUPPORT);
        } else if (m16433a(routePara)) {
            try {
                Intent intent = new Intent("android.intent.action.VIEW");
                intent.addFlags(276824064);
                intent.addCategory("android.intent.category.DEFAULT");
                intent.setData(Uri.parse(m16434b(routePara, context, i)));
                intent.setPackage("com.autonavi.minimap");
                new C3364a("oan", context).start();
                context.startActivity(intent);
            } catch (Throwable th) {
    ...
    private static boolean m16433a(RoutePara routePara) {
    ...
    private static String m16429a(NaviPara naviPara, Context context) {
        return String.format("androidamap://navi?sourceApplication=%s&lat=%f&lon=%f&dev=0&style=%d", new Object[]{bm.m15686b(context), Double.valueOf(naviPara.getTargetPoint().latitude), Double.valueOf(naviPara.getTargetPoint().longitude), Integer.valueOf(naviPara.getNaviStyle())});
    }

    private static String m16434b(RoutePara routePara, Context context, int i) {
        String format = String.format("androidamap://route?sourceApplication=%s&slat=%f&slon=%f&sname=%s&dlat=%f&dlon=%f&dname=%s&dev=0&t=%d", new Object[]{bm.m15686b(context), Double.valueOf(routePara.getStartPoint().latitude), Double.valueOf(routePara.getStartPoint().longitude), routePara.getStartName(), Double.valueOf(routePara.getEndPoint().latitude), Double.valueOf(routePara.getEndPoint().longitude), routePara.getEndName(), Integer.valueOf(i)});
        if (i == 1) {
    ...
    private static String m16430a(PoiPara poiPara, Context context) {
        String format = String.format("androidamap://arroundpoi?sourceApplication=%s&keywords=%s&dev=0", new Object[]{bm.m15686b(context), poiPara.getKeywords()});
    ...
    private static boolean m16432a(Context context) {
        try {
