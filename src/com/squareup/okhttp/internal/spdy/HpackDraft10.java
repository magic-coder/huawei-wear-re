...
final class HpackDraft10 {
    ...
    final class Reader {
        ...
        private void readIndexedHeader(int i) throws IOException {
            if (isStaticHeader(i)) {
                this.headerList.add(HpackDraft10.STATIC_HEADER_TABLE[i]);
                return;
            }
            int dynamicTableIndex = dynamicTableIndex(i - HpackDraft10.STATIC_HEADER_TABLE.length);
        ...
        private void readLiteralHeaderWithoutIndexingNewName() throws IOException {
            this.headerList.add(new Header(HpackDraft10.checkLowercase(readByteString()), readByteString()));
        }
        ...
        private void readLiteralHeaderWithIncrementalIndexingNewName() throws IOException {
            insertIntoDynamicTable(-1, new Header(HpackDraft10.checkLowercase(readByteString()), readByteString()));
        }

        private ByteString getName(int i) {
            if (isStaticHeader(i)) {
                return HpackDraft10.STATIC_HEADER_TABLE[i].name;
            }
            return this.dynamicTable[dynamicTableIndex(i - HpackDraft10.STATIC_HEADER_TABLE.length)].name;
        }

        private boolean isStaticHeader(int i) {
            return i >= 0 && i <= HpackDraft10.STATIC_HEADER_TABLE.length - 1;
        }
    ...
    final class Writer {
        ...
        void writeHeaders(List<Header> list) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Integer num = (Integer) HpackDraft10.NAME_TO_FIRST_INDEX.get(toAsciiLowercase);
                if (num != null) {
