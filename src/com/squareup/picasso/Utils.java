...
final class Utils {
    ...
    final class C26711 extends Handler {
        C26711(Looper looper) {
            super(looper);
        }
    ...
    static boolean parseResponseSourceHeader(String str) {
        ...
        String[] split = str.split(HwAccountConstants.BLANK, 2);
    ...
    static void flushStackLocalLeaks(Looper looper) {
        Handler c26711 = new C26711(looper);
        c26711.sendMessageDelayed(c26711.obtainMessage(), 1000);
    }
}
