...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C26572();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C26561();
    ...
    final class C26561 extends ThreadLocal<StringBuilder> {
        C26561() {
        }
    ...
    final class C26572 extends RequestHandler {
        C26572() {
        }
    ...
    final class C26583 implements Runnable {
        final /* synthetic */ RuntimeException val$e;
        final /* synthetic */ Transformation val$transformation;

        C26583(Transformation transformation, RuntimeException runtimeException) {
    ...
    final class C26594 implements Runnable {
        final /* synthetic */ StringBuilder val$builder;

        C26594(StringBuilder stringBuilder) {
    ...
    final class C26605 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C26605(Transformation transformation) {
            this.val$transformation = transformation;
        }
    ...
    final class C26616 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C26616(Transformation transformation) {
            this.val$transformation = transformation;
        }
        ...
        while (i < size) {
            ...
            try {
                ...
                if (bitmap == null) {
                    ...
                    Picasso.HANDLER.post(new C26594(append));
                    return null;
                } else if (bitmap == bitmap2 && bitmap2.isRecycled()) {
                    Picasso.HANDLER.post(new C26605(transformation2));
                    return null;
                } else if (bitmap == bitmap2 || bitmap2.isRecycled()) {
                    i++;
                    bitmap2 = bitmap;
                } else {
                    Picasso.HANDLER.post(new C26616(transformation2));
                    return null;
                }
            } catch (RuntimeException e) {
                Picasso.HANDLER.post(new C26583(transformation2, e));
                return null;
            }
        }
        return bitmap2;
