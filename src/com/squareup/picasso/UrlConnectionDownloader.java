...
public class UrlConnectionDownloader implements Downloader {
    private static final ThreadLocal<StringBuilder> CACHE_HEADER_BUILDER = new C26701();
    ...
    final class C26701 extends ThreadLocal<StringBuilder> {
        C26701() {
        }
    ...
    public Response load(Uri uri, int i) throws IOException {
        ...
        if (responseCode >= 300) {
            ...
            throw new ResponseException(responseCode + HwAccountConstants.BLANK + openConnection.getResponseMessage(), i, responseCode);
        }
