...
public class Picasso {
    static final Handler HANDLER = new C26651(Looper.getMainLooper());
    ...
    final class C26651 extends Handler {
        C26651(Looper looper) {
            super(looper);
        }
    ...
    public interface RequestTransformer {
        public static final RequestTransformer IDENTITY = new C26671();

        final class C26671 implements RequestTransformer {
            C26671() {
            }
