...
public class Convert {
    ...
    public static byte[] get1BString(String str) {
        try {
            ...
            byteArrayOutputStream.write(new byte[]{(byte) str.getBytes(GameManager.DEFAULT_CHARSET).length});
    ...
    public static void convert1bString(byte[] bArr, int i, C3522b c3522b) {
        try {
            c3522b.f13276a = bArr[i];
            c3522b.f13277b = new String(bArr, i + 1, c3522b.f13276a, GameManager.DEFAULT_CHARSET);
        } catch (Exception e) {
            e.printStackTrace();
            c3522b.f13276a = 0;
            c3522b.f13277b = "";
    ...
    public static void convert2bString(byte[] bArr, int i, C3522b c3522b) {
        try {
            c3522b.f13276a = getShort(bArr, i);
            c3522b.f13277b = new String(bArr, i + 2, c3522b.f13276a, GameManager.DEFAULT_CHARSET);
        } catch (Exception e) {
            e.printStackTrace();
            c3522b.f13276a = 0;
            c3522b.f13277b = "";
