...
public class MapCore {
    ...
    public void newMap() {
        ...
        this.native_instance = nativeNewInstance(MapTilsCacheAndResManager.getInstance(this.mContext).getBaseMapPath(), this.textTextureGenerator.getFontVersion());
        bf.m15627a(bf.f11497a, hashCode() + " new Map instance: " + this.native_instance, 111);
    }
    ...
    public boolean putMapData(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        bf.m15627a(bf.f11497a, hashCode() + " putMapData start", 111);
        ...
        bf.m15627a(bf.f11497a, hashCode() + " putMapData finish state: " + z + HwAccountConstants.BLANK, 111);
    ...
    public void OnMapDataRequired(int i, String[] strArr) {
        bf.m15627a(bf.f11497a, hashCode() + " MapDataRequire  datasourceType: " + i, 111);
        bf.m15627a(bf.f11497a, hashCode() + " MapCallback: " + this.mMapcallback, 111);
        if (this.mMapcallback != null) {
            try {
    ...
    public void fillCurGridListWithDataType(ArrayList<MapSourceGridData> arrayList, int i) {
        if (this.native_instance != 0) {
            ...
            if (b > (byte) 0 && b <= TagName.PAY_ORDER_LIST && arrayList != null) {
                arrayList.clear();
                byte b2 = (byte) 0;
                int i2 = 1;
                while (b2 < b && i2 < 3072) {
                    ...
                    if (b3 > (byte) 0 && b3 <= TagName.ORDER_TIME && i3 + b3 <= 3072) {
