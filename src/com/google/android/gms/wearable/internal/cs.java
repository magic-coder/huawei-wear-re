...
public class cs {
    ...
    public static cs m2090a(Context context) {
        C0424f.m649a((Object) context);
        synchronized (cs.class) {
            if (f1020c == null) {
                f1020c = new cs(context);
            }
        }
        return f1020c;
    }

    private boolean m2091a(PackageInfo packageInfo, byte[]... bArr) {
    ...
    private static byte[] m2092b(String str) {
        try {
    ...
    private PackageInfo m2093c(String str) {
        try {
            return cy.m1181b(this.f1021d).m1180b(str, 64);
        } catch (NameNotFoundException e) {
            String str2 = "WearSignatureVerifier";
    ...
    boolean m2094a(PackageInfo packageInfo, boolean z) {
        if (packageInfo.signatures.length != 1) {
            Log.w("WearSignatureVerifier", "Package has more than one signature.");
            return false;
        }
        ...
        if (z) {
            return m2091a(packageInfo, f1018a, f1019b);
        }
        return m2091a(packageInfo, f1018a);
    }

    public boolean m2095a(String str) {
        PackageInfo c = m2093c(str);
        if (c == null) {
            return false;
        }
        if (C0391p.m455d(this.f1021d)) {
            return m2094a(c, true);
        }
        boolean a = m2094a(c, false);
        if (a || !m2094a(c, true)) {
            return a;
        }
