...
public class zzayz extends zza implements Comparable<zzayz> {
    public static final Creator<zzayz> CREATOR = new df();
    private static final Charset UTF_8 = Charset.forName(GameManager.DEFAULT_CHARSET);
    public static final de zzbBG = new de();
    ...
    public boolean equals(Object obj) {
        ...
        if (!C0421c.m647a(this.name, com_google_android_gms_internal_zzayz.name) || this.zzbBE != com_google_android_gms_internal_zzayz.zzbBE || this.zzbBF != com_google_android_gms_internal_zzayz.zzbBF) {
            return false;
        }
        switch (this.zzbBE) {
            case 1:
            ...
            case 4:
                return C0421c.m647a(this.zzaGV, com_google_android_gms_internal_zzayz.zzaGV);
            case 5:
