...
public class BitmapTeleporter extends zza implements ReflectedParcelable {
    public static final Creator<BitmapTeleporter> CREATOR = new C0400h();
    ...
    private FileOutputStream zzxh() {
        ...
        try {
            ...
            try {
                ...
                this.zzSQ = ParcelFileDescriptor.open(createTempFile, SQLiteDatabase.CREATE_IF_NECESSARY);
