...
import com.google.android.gms.common.util.C0460e;
import com.google.android.gms.common.util.C0461f;
...
public class GoogleSignInAccount extends zza implements ReflectedParcelable {
    public static final Creator<GoogleSignInAccount> CREATOR = new C0352e();
    public static C0460e zzajZ = C0461f.m814b();
    private static Comparator<Scope> zzakg = new C0348a();
    ...
    public static GoogleSignInAccount zza(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6, @Nullable Uri uri, @Nullable Long l, @NonNull String str7, @NonNull Set<Scope> set) {
        if (l == null) {
            l = Long.valueOf(zzajZ.mo1788a() / 1000);
        }
        return new GoogleSignInAccount(3, str, str2, str3, str4, uri, null, l.longValue(), C0424f.m651a(str7), new ArrayList((Collection) C0424f.m649a((Object) set)), str5, str6);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        C0352e.m285a(this, parcel, i);
    }

    public boolean zza() {
        return zzajZ.mo1788a() / 1000 >= this.zzake - 300;
    }
