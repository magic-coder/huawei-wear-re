package com.google.analytics.p268a.p269a;
...
/* compiled from: Key */
public enum C3630a {
    ACCOUNT(HwAccountConstants.ACCOUNT_KEY),
    ACTIVITY("activity"),
    ...
    LOCATION(LocationManagerProxy.KEY_LOCATION_CHANGED),
    MAP("map"),
    MAX("max"),
    MIN("min"),
    METRIC("metric"),
    ...
    PARTITION("partition"),
    PIXEL("pixel"),
    PLATFORM(LogBuilder.KEY_PLATFORM),
    PRICES("prices"),
    PRIORITY(JoinConstants.PRIORITY),
    PRODUCT(BuildConfig.environment),
    PRODUCT_ID(CardProductInfoColumns.COLUMN_NAME_PRODUCT_ID),
    ...
    USER_ID(ReportCardInfo.COLUMN_NAME_CARD_USERID),
