...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new C06192();
    public static final TypeAdapterFactory BIT_SET_FACTORY = newFactory(BitSet.class, BIT_SET);
    public static final TypeAdapter<Boolean> BOOLEAN = new C06203();
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new C06214();
    public static final TypeAdapterFactory BOOLEAN_FACTORY = newFactory(Boolean.TYPE, Boolean.class, BOOLEAN);
    public static final TypeAdapter<Number> BYTE = new C06225();
    ...
    public static final TypeAdapter<Class> CLASS = new C06171();
    ...
    public static final TypeAdapter<Number> FLOAT = new C06269();
    ...
    public static final TypeAdapter<Number> INTEGER = new C06247();
    ...
    public static final TypeAdapter<Locale> LOCALE = new TypeAdapter<Locale>() {
        public Locale read(JsonReader jsonReader) throws IOException {
            ...
            String nextToken2;
            String nextToken3;
            StringTokenizer stringTokenizer = new StringTokenizer(jsonReader.nextString(), HwAccountConstants.SPLIIT_UNDERLINE);
    ...
    public static final TypeAdapter<Number> LONG = new C06258();
    ...
    public static final TypeAdapter<Number> SHORT = new C06236();
    ...
    final class C06171 extends TypeAdapter<Class> {
        C06171() {
        }
    ...
    final class C06192 extends TypeAdapter<BitSet> {
        C06192() {
        }
    ...
    final class C06203 extends TypeAdapter<Boolean> {
        C06203() {
        }
    ...
    final class C06214 extends TypeAdapter<Boolean> {
        C06214() {
        }
    ...
    final class C06225 extends TypeAdapter<Number> {
        C06225() {
        }
    ...
    final class C06236 extends TypeAdapter<Number> {
        C06236() {
        }
    ...
    final class C06247 extends TypeAdapter<Number> {
        C06247() {
        }
    ...
    final class C06258 extends TypeAdapter<Number> {
        C06258() {
        }
    ...
    final class C06269 extends TypeAdapter<Number> {
        C06269() {
        }
