...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C06001();
    ...
    final class C06001 implements Comparator<Comparable> {
        C06001() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C06011 extends LinkedTreeMapIterator<Entry<K, V>> {
            C06011() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C06021 extends LinkedTreeMapIterator<K> {
            C06021() {
                super();
            }
