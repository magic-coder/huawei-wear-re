...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C05971();
    ...
    final class C05971 implements Comparator<Comparable> {
        C05971() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05981 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05981() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05991 extends LinkedTreeMapIterator<K> {
            C05991() {
                super();
            }
