...
public class JsonReader implements Closeable {
    ...
    final class C06271 extends JsonReaderInternalAccess {
        C06271() {
        }
        ...
        public void promoteNameToValue(JsonReader jsonReader) throws IOException {
            ...
            if (access$000 == 13) {
                ...
                throw new IllegalStateException("Expected a name but was " + jsonReader.peek() + HwAccountConstants.BLANK + " at line " + jsonReader.getLineNumber() + " column " + jsonReader.getColumnNumber() + " path " + jsonReader.getPath());
            }
        }
    }

    static {
        JsonReaderInternalAccess.INSTANCE = new C06271();
    }
