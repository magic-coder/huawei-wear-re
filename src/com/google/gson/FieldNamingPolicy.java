...
public enum FieldNamingPolicy implements FieldNamingStrategy {
    ...
    UPPER_CAMEL_CASE_WITH_SPACES {
        public String translateName(Field field) {
            return FieldNamingPolicy.upperCaseFirstLetter(FieldNamingPolicy.separateCamelCase(field.getName(), HwAccountConstants.BLANK));
        }
    },
    LOWER_CASE_WITH_UNDERSCORES {
        public String translateName(Field field) {
            return FieldNamingPolicy.separateCamelCase(field.getName(), HwAccountConstants.SPLIIT_UNDERLINE).toLowerCase();
        }
    },
