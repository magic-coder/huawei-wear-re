...
public final class Gson {
    ...
    class C05781 implements JsonDeserializationContext {
        C05781() {
        }
    ...
    class C05792 implements JsonSerializationContext {
        C05792() {
        }
    ...
    class C05803 extends TypeAdapter<Number> {
        C05803() {
        }
    ...
    class C05814 extends TypeAdapter<Number> {
        C05814() {
        }
    ...
    class C05825 extends TypeAdapter<Number> {
        C05825() {
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new C05781();
        this.serializationContext = new C05792();
