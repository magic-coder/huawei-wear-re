...
final class RealBufferedSource implements BufferedSource {
    ...
    class C27621 extends InputStream {
        C27621() {
        }
    ...
    public long readDecimalLong() throws IOException {
        ...
        while (request((long) (i + 1))) {
            ...
            if ((b < TagName.APK_SIZE || b > ScriptToolsConst.TagName.TagApdu) && !(i == 0 && b == TagName.APK_UPDATE_FLAG)) {
                if (i == 0) {
    ...
    public long readHexadecimalUnsignedLong() throws IOException {
        ...
        for (int i = 0; request((long) (i + 1)); i++) {
            byte b = this.buffer.getByte((long) i);
            if ((b < TagName.APK_SIZE || b > ScriptToolsConst.TagName.TagApdu) && ((b < TagName.MAIN_ORDER_LIST || b > (byte) 102) && (b < TagName.TERMINAL_BACK_CONTENT || b > TagName.TERMINAL_BASEBAND_VERSION))) {
                if (i == 0) {
