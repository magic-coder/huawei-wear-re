...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private boolean verifyHostname(String str, X509Certificate x509Certificate) {
        ...
        if (obj == null) {
            String findMostSpecific = new DistinguishedNameParser(x509Certificate.getSubjectX500Principal()).findMostSpecific(HwAccountConstants.DEFAULT_SIMPLE_COUNTRY_CODE);
