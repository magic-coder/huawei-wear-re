...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private static final Sink NULL_SINK = new C27304();
    private static final String READ = "READ";
    private static final String REMOVE = "REMOVE";
    static final String VERSION_1 = "1";
    private final int appVersion;
    private final Runnable cleanupRunnable = new C27271();
    ...
    class C27293 implements Iterator<Snapshot> {
    ...
    final class C27304 implements Sink {
        C27304() {
        }
    ...
    public final class Editor {
        ...
        public Sink newSink(int i) throws IOException {
            ...
            synchronized (DiskLruCache.this) {
                ...
                try {
                    c27311 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) {
