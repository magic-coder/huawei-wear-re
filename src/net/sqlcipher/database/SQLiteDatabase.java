...
*/
    ...
    public long insertWithOnConflict(String str, String str2, ContentValues contentValues, int i) {
        ...
        if (isOpen()) {
            Set set;
            StringBuilder stringBuilder = new StringBuilder(SyslogAppender.LOG_LOCAL3);
            ...
            if (contentValues == null || contentValues.size() <= 0) {
                ...
                stringBuilder2.append(DateLayout.NULL_DATE_FORMAT);
                set = null;
            } else {
    ...
    L_0x0031:
        ...
        monitor-enter(r1);
        r0 = r4.mCompiledQueries;	 Catch:{ all -> 0x0040 }
        r0 = r0.get(r5);	 Catch:{ all -> 0x0040 }
        r0 = (net.sqlcipher.database.SQLiteCompiledSql) r0;	 Catch:{ all -> 0x0040 }
    ...
    L_0x0043:
        ...
        r2 = r4.mMaxSqlCacheSize;	 Catch:{ all -> 0x0040 }
        if (r0 != r2) goto L_0x008a;
    L_0x004d:
        r0 = r4.mCacheFullWarnings;	 Catch:{ all -> 0x0040 }
        r0 = r0 + 1;
        r4.mCacheFullWarnings = r0;	 Catch:{ all -> 0x0040 }
        r2 = 1;
        if (r0 != r2) goto L_0x0088;
    L_0x0056:
        r0 = "Database";
        r2 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0040 }
        r2.<init>();	 Catch:{ all -> 0x0040 }
        r3 = "Reached MAX size for compiled-sql statement cache for database ";
        r2 = r2.append(r3);	 Catch:{ all -> 0x0040 }
        r3 = r4.getPath();	 Catch:{ all -> 0x0040 }
        r2 = r2.append(r3);	 Catch:{ all -> 0x0040 }
        r3 = "; i.e., NO space for this sql statement in cache: ";
        r2 = r2.append(r3);	 Catch:{ all -> 0x0040 }
        r2 = r2.append(r5);	 Catch:{ all -> 0x0040 }
        r3 = ". Please change your sql statements to use '?' for ";
        r2 = r2.append(r3);	 Catch:{ all -> 0x0040 }
        r3 = "bindargs, instead of using actual values";
        r2 = r2.append(r3);	 Catch:{ all -> 0x0040 }
        r2 = r2.toString();	 Catch:{ all -> 0x0040 }
        android.util.Log.w(r0, r2);	 Catch:{ all -> 0x0040 }
    L_0x0088:
        monitor-exit(r1);	 Catch:{ all -> 0x0040 }
        goto L_0x0030;
    L_0x008a:
        r0 = r4.mCompiledQueries;	 Catch:{ all -> 0x0040 }
        r0.put(r5, r6);	 Catch:{ all -> 0x0040 }
        r0 = net.sqlcipher.database.SQLiteDebug.DEBUG_SQL_CACHE;	 Catch:{ all -> 0x0040 }
    ...
    L_0x0093:
        ...
        r3 = "|";
        r2 = r2.append(r3);	 Catch:{ all -> 0x0040 }
        r3 = r4.mCompiledQueries;	 Catch:{ all -> 0x0040 }
        ...
        r2 = r2.append(r5);	 Catch:{ all -> 0x0040 }
        r2 = r2.toString();	 Catch:{ all -> 0x0040 }
        android.util.Log.v(r0, r2);	 Catch:{ all -> 0x0040 }
        goto L_0x0088;
        */
